        ...
        return (
            <>
                ...
                <div class=" ant-form-item ant-form-item-with-help x-item flex ">
                    <xItem configs={vm.configs.minimum} v-model={vm.data.minimum} class="flex1" parser={val => vm.parserNum(val)} />
                    <xItem configs={vm.configs.exclusiveMinimum} v-model={vm.data.exclusiveMinimum} />
                    <xGap r="16" />
                </div>
                <xGap t="10" />
                <div class=" ant-form-item ant-form-item-with-help x-item flex ">
                    <xItem configs={vm.configs.maximum} v-model={vm.data.maximum} class="flex1" parser={val => vm.parserNum(val)} />
                    <xItem configs={vm.configs.exclusiveMaximum} v-model={vm.data.exclusiveMaximum} />
                    <xGap r="16" />
                </div>
                <xGap t="10" />
