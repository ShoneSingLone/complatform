...
(function(AMDLoader) {
    ...
    var Configuration = /** @class */ (function() {
        ...
        Configuration.prototype.moduleIdToPaths = function(moduleId) {
            if (this._env.isNode) {
                var isNodeModule = ((this.nodeModulesMap[moduleId] === true) || (this.options.amdModulesPattern instanceof RegExp && !this.options.amdModulesPattern.test(moduleId)));
                if (isNodeModule) {
        ...
        Configuration.prototype.shouldInvokeFactory = function(strModuleId) {
            ...
            return (this.options.buildForceInvokeFactory[strModuleId] || AMDLoader.Utilities.isAnonymousModule(strModuleId));
        };
        /**
...
(function(AMDLoader) {
    ...
    function canUseEval(moduleManager) {
        var trustedTypesPolicy = moduleManager.getConfig().getOptionsLiteral().trustedTypesPolicy;
        try {
            var func = (trustedTypesPolicy ? self.eval(trustedTypesPolicy.createScript('', 'true')) : new Function('true'));
            func.call(self);
            return true;
        } catch (err) {
            return false;
            ...
            if (/^node\|/.test(scriptSrc)) {
                ...
                if (!isCrossOrigin && this._canUseEval(moduleManager)) {
                    ...
                    fetch(scriptSrc).then(function(response) {
                        ...
                        text = text + "\n//# sourceURL=" + scriptSrc;
                        var func = (trustedTypesPolicy_1 ? self.eval(trustedTypesPolicy_1.createScript('', text)) : new Function(text));
                        func.call(self);
                        callback();
    ...
    var ModuleManager = /** @class */ (function() {
        ...
        ModuleManager.prototype._onModuleComplete = function(module) {
            ...
            var inversedependenciesProvider = function(moduleId) {
                return (_this._inverseDependencies2[moduleId] || []).map(function(intModuleId) {
                    return _this._moduleIdProvider.getStrModuleId(intModuleId);
                });
            };
