  ...
  resolve(defineComponent({
    ...
    render(vm) {
      return createVNode(Fragment, null, [vm.readonly && withDirectives(createVNode("div", {
        ...
        "style": "height:300px;width:100%;z-index:1;padding:20px;"
      }, null), [[resolveDirective("uiPopover"), vm.configsPopoverChangeTheme], [resolveDirective("loading"), vm.isLoading]]), createVNode("div", {
        "class": "display-none"
      }, [createVNode(resolveComponent("a-image"), {
        "src": vm.imgSrc,
        "preview": {
          visible: vm.visible,
